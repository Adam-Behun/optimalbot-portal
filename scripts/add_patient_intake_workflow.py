#!/usr/bin/env python3
"""
Add patient_intake workflow to demo_clinic_beta organization.

Run: python scripts/add_patient_intake_workflow.py
"""
...
async def main():
    ...
    print("=" * 60)
    print("Adding patient_intake workflow to demo_clinic_beta")
    print("=" * 60)
    ...
    patient_intake_workflow = {
        ...
        "patient_schema": {
            "fields": [
                # Patient type
                {"key": "is_new_patient", "label": "New Patient", "type": "boolean", "required": False, "display_in_list": False, "display_order": 1, "computed": True},
                {"key": "service_type", "label": "Service Type", "type": "string", "required": False, "display_in_list": True, "display_order": 2, "computed": True},
                ...
                {"key": "patient_name", "label": "Patient Name", "type": "string", "required": False, "display_in_list": True, "display_order": 5, "computed": True},
                {"key": "phone_number", "label": "Phone Number", "type": "phone", "required": False, "display_in_list": False, "display_order": 6, "computed": True},
                {"key": "date_of_birth", "label": "Date of Birth", "type": "date", "required": False, "display_in_list": False, "display_order": 7, "computed": True},
                {"key": "email", "label": "Email", "type": "string", "required": False, "display_in_list": False, "display_order": 8, "computed": True},

                # Appointment info
                {"key": "appointment_date", "label": "Appointment Date", "type": "string", "required": False, "display_in_list": True, "display_order": 9, "computed": True},
                {"key": "appointment_time", "label": "Appointment Time", "type": "string", "required": False, "display_in_list": True, "display_order": 10, "computed": True},

                # System fields
                {"key": "call_status", "label": "Call Status", "type": "string", "required": False, "display_in_list": True, "display_order": 11, "computed": True},
                {"key": "created_at", "label": "Created", "type": "datetime", "required": False, "display_in_list": False, "display_order": 12, "computed": True},
                {"key": "updated_at", "label": "Last Updated", "type": "datetime", "required": False, "display_in_list": True, "display_order": 13, "computed": True}
            ]
        }
    }

    # Update demo_clinic_beta organization to add patient_intake workflow
    ...
    if result.modified_count > 0:
        print("  ✓ Added patient_intake workflow to demo_clinic_beta")
    else:
