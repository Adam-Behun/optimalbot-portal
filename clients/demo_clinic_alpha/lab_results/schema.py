WORKFLOW_SCHEMA = {
    ...
    "patient_schema": {
        "fields": [
            ...
            {"key": "test_type", "label": "Test Type", "type": "string", "required": False, "display_in_list": True, "display_order": 7, "computed": False},
            {"key": "test_date", "label": "Test Date", "type": "date", "required": False, "display_in_list": True, "display_order": 8, "computed": False},
            ...
            {"key": "results_status", "label": "Results Status", "type": "string", "required": False, "display_in_list": True, "display_order": 10, "computed": False},
