WORKFLOW_SCHEMA = {
    ...
    "session_schema": {
        "fields": [
            # Call classification
            {"key": "call_type", "label": "Call Type", "type": "string", "required": False, "display_in_list": True, "display_order": 1, "display_priority": "tablet", "computed": True},
            {"key": "call_reason", "label": "Call Reason", "type": "string", "required": False, "display_in_list": True, "display_order": 2, "display_priority": "desktop", "computed": True},
            # Caller info (collected during call)
            {"key": "caller_name", "label": "Caller Name", "type": "string", "required": False, "display_in_list": True, "display_order": 3, "display_priority": "mobile", "computed": True},
            {"key": "caller_phone_number", "label": "Caller Phone", "type": "phone", "required": False, "display_in_list": True, "display_order": 4, "display_priority": "desktop", "computed": True},
            # Routing - values like "scheduling (AI)", "Billing (staff)", "Answered Directly"
            {"key": "routed_to", "label": "Routed To", "type": "string", "required": False, "display_in_list": True, "display_order": 5, "display_priority": "mobile", "computed": True},
            # Outcome
            {"key": "resolution", "label": "Resolution", "type": "string", "required": False, "display_in_list": False, "display_order": 6, "computed": True},
            {"key": "call_status", "label": "Call Status", "type": "string", "required": False, "display_in_list": True, "display_order": 7, "display_priority": "mobile", "computed": True},
